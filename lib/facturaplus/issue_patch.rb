  ...
  module IssuePatch
    ...
    module InstanceMethods
      ...
      def facturaplus_bill_save
        ...
        elsif tracker_id.to_s == Setting.plugin_redmine_facturaplus['bill_tracker'] and Setting.plugin_redmine_facturaplus['billed_statuses'].include?(status_was.id.to_s) and Setting.plugin_redmine_facturaplus['billed_statuses'].include?(status_id.to_s)
          # El estado del ticket estaba un estado facturado y no sale de ese estado, por lo que no se puede modificar -> ERROR
